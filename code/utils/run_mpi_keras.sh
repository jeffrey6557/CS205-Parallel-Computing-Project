...
#SBATCH -o MPI_keras_%j.out       # Standard out goes to this file
#SBATCH -e MPI_keras_%j.err       # Standard err goes to this filehostname
...
srun -n $SLURM_NTASKS -c $SLURM_CPUS_PER_TASK --mpi=pmi2 python MPI_keras.py