...
sampCol = c("lightgray","darkgoldenrod3","grey17","darkolivegreen2","gray42","aquamarine","darkgoldenrod",  "gray87","deepskyblue3","azure","grey55","chocolate4","mistyrose1","grey19","grey95","cadetblue3", "palegreen1", "darkorange")
            [19] "turquoise3"  )
...
legend(length(times)+5.5,425, legend = c("Hessian-free GPU", "ADA CPU","ADA GPU","MPI+ADA 3 nodes 4 cores", "MPI+ADA 4 nodes 4 cores", "MPI+ADA 4 nodes 8 cores", "MPI+ADA 5 Nodes 4 cores", "MPI+ADA 6 nodes 4 cores", "MPI+ADA 7 nodes 4 cores", "MPI+ADA 8 nodes 4 cores", "ADA CPU\nbig batch","ADA GPU\nbig batch","MPI+ADA 3 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 8 cores\nbig batch", "MPI+ADA 5 Nodes 4 cores\nbig batch", "MPI+ADA 6 nodes 4 cores\nbig batch", "MPI+ADA 7 nodes 4 cores\nbig batch", "MPI+ADA 8 nodes 4 cores\nbig batch"), fill = sampCol, cex = .6, y.intersp = 1.5)
dev.off()
...
legend(length(times)+5.5,10, legend = c("Hessian-free GPU", "ADA CPU","ADA GPU","MPI+ADA 3 nodes 4 cores", "MPI+ADA 4 nodes 4 cores", "MPI+ADA 4 nodes 8 cores", "MPI+ADA 5 Nodes 4 cores", "MPI+ADA 6 nodes 4 cores", "MPI+ADA 7 nodes 4 cores", "MPI+ADA 8 nodes 4 cores", "ADA CPU\nbig batch","ADA GPU\nbig batch","MPI+ADA 3 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 8 cores\nbig batch", "MPI+ADA 5 Nodes 4 cores\nbig batch", "MPI+ADA 6 nodes 4 cores\nbig batch", "MPI+ADA 7 nodes 4 cores\nbig batch", "MPI+ADA 8 nodes 4 cores\nbig batch"), fill = sampCol, cex = .6, y.intersp = 1.5)
dev.off()
...
ada20 = c(1228.72130013/98,906.030404091/100,823.905865192/100,635.600432873/100,605.052289009/100, 444.832736969/100)/20
...
legend(length(times)+5.5,.615, legend = c("Hessian-free GPU", "ADA CPU","ADA GPU","MPI+ADA 3 nodes 4 cores", "MPI+ADA 4 nodes 4 cores", "MPI+ADA 4 nodes 8 cores", "MPI+ADA 5 Nodes 4 cores", "MPI+ADA 6 nodes 4 cores", "MPI+ADA 7 nodes 4 cores", "MPI+ADA 8 nodes 4 cores", "ADA CPU\nbig batch","ADA GPU\nbig batch","MPI+ADA 3 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 4 cores\nbig batch", "MPI+ADA 4 nodes 8 cores\nbig batch", "MPI+ADA 5 Nodes 4 cores\nbig batch", "MPI+ADA 6 nodes 4 cores\nbig batch", "MPI+ADA 7 nodes 4 cores\nbig batch", "MPI+ADA 8 nodes 4 cores\nbig batch"), fill = sampCol, cex = .6, y.intersp = 1.5)
dev.off()
